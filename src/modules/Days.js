...
export class Day {
  ...
  createDayOnCard() {
    ...
    document
      .getElementById("notes-box-top")
      .insertAdjacentHTML("afterend", todosListHtml);
...
const displaySaveExitButton = () => {
  ...
  document
    .getElementById("close-day-wrapper")
    .insertAdjacentHTML("afterbegin", saveexitBtnGen);
};

export const handleDayandFormBoxClick = (
  currentId,
  currentStyle,
  dayNameAttribute
) => {
